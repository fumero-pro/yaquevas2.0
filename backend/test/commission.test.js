...
test('comisión por defecto es 6% remitente + 6% viajero = 12% total', () => {
...
test('respeta porcentajes configurables distintos del 6/6 por defecto', () => {
...
test('redondea a 2 decimales de forma consistente', () => {
