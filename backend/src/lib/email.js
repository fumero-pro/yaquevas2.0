...
function welcomeEmailHtml(name, verifyUrl) {
  return `
    <div style="font-family:sans-serif; max-width:480px; margin:0 auto; color:#14181F;">
      ...
      ${verifyUrl ? `
      <p style="margin-top:24px;"><a href="${verifyUrl}" style="background:#FF6B4A;color:#14181F;padding:12px 20px;border-radius:10px;text-decoration:none;font-weight:700;">Confirmar mi email</a></p>
      <p style="color:#5B6472; font-size:0.85rem;">Confírmalo para que tus notificaciones lleguen sin problema. El enlace caduca en 48 horas.</p>
      ` : `
      ...
      persona complete su primera operación, ganáis los dos un descuento en la comisión de
      vuestra próxima operación.</p>
    </div>
  `;
}
